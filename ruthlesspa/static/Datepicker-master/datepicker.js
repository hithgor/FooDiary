...
const instanceDatepicker = new Datepicker(document.getElementById("datepicker"));

instanceDatepicker.config({
    firstdate: new Date(2017, 0, 1), 
    lastdate: new Date(2020, 11, 31),
    format: instanceDatepicker => { return (months_short[instanceDatepicker.getMonth()] + " " + instanceDatepicker.getDate()+ " " + instanceDatepicker.getFullYear()); }
    ///format: instanceDatepicker => { return (instanceDatepicker.getFullYear() + " " + instanceDatepicker.///getMonth() + " " + instanceDatepicker.getDay()) } 
});


var searchedDate = instanceDatepicker.getDate().toISOString().substring(0, 10);
const instanceDatepickerInput = document.getElementById("datepicker");
const testTD = document.getElementsByClassName('pointer');
...
todayBtn.addEventListener('click', function() {
    searchedDate = instanceDatepicker.getDate().toISOString().substring(0, 10);
    console.log(searchedDate);
    var x = (new Date(instanceDatepicker.getDate() - tzoffset));
    console.log("NEW TIME: " + x.toISOString());
    searchedDate = x.toISOString().substring(0, 10);
